    ...
    <body>
        <div class="d-flex" id="wrapper">
          ...
          <div class="container-fluid">           
             ...
             <table class="table">
            <tr>
                <td><label for="validationCustom04" class="form-label">Abogados: </label></td>
                <td> <select name="selectAbo" class="form-select" id="validationCustom04" required>
                            ...
                            <div class="col-sm-3">
                                <div class="card">                                   
                                    ...
                                    <div class="card-footer text-center bg-light" >
                                        <label class=""><%=p.getNomA()%> </label><br>
                                        <label class=""><%=p.getEsp()%> </label>
                                         <div>
                                             <a href="" class="btn btn-outline-danger"> Ver Perfil</a>
                                             <a href="" class="btn btn-outline-primary" >Asesoria</a>
                                         </div>
                                    </div>
                                </div>
                            </div>
